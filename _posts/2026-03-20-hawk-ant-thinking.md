...
image:
  path: /assets/img/posts/hawk-ant-thinking-framework.png
...
## เรารู้พอหรือยัง ก่อนจะถามว่า "ทำไม"?

คนส่วนใหญ่เจอปัญหาแล้วถาม "ทำไม?" ทันที ฟังดูเป็นคำถามที่ดี ฟังดูเป็นจุดเริ่มต้นของการคิดอย่างมีเหตุผล

แต่ "ทำไม" จะมีความหมายก็ต่อเมื่อรู้ก่อนว่ากำลังถามทำไมกับ "อะไร" — ถ้ายังไม่แน่ใจว่าสิ่งที่เห็นคืออะไรจริงๆ "ทำไม" จะพาไปหาคำตอบที่ถูกต้องของคำถามที่ผิด ซึ่งอันตรายกว่าไม่ถามเลย เพราะมันสร้างความมั่นใจในสิ่งที่ไม่จริง

ลำดับที่ถูกต้องไม่ใช่ เห็น → ทำไม → แก้ยังไง แต่คือ เห็น → สำรวจให้พอ → **รู้พอหรือยัง?** → ทำไม → แก้ยังไง

คำถาม "รู้พอหรือยัง?" คือตัวกั้นที่สำคัญที่สุด ถ้าตอบไม่ได้ — ยังไม่มีสิทธิ์ถาม "ทำไม" ถ้าตอบไม่ได้แม้แต่ว่า "รู้พอหรือยัง" — นั่นเองคือสัญญาณว่ายังไม่พอ
...
มันแสดง **พฤติกรรม (Behaviour)** อะไรอยู่? ปกติหรือผิดจากที่เคยเป็น? แล้วมันตอบสนองต่ออะไร? และพฤติกรรมนี้เป็นแค่เหตุการณ์ครั้งเดียว หรือเป็นรูปแบบที่ทำซ้ำจนกลายเป็น "ปกติ"? ปกติที่ไม่มีใครตั้งคำถามอาจเป็นจุดบอดที่อันตรายที่สุด
...
![Hawk–Lens-Senses](/assets/img/posts/Hawk-Lens-and-Senses.png)
_Lens & Sense เพื่อหาว่าปัญหาอยู่ตรงไหน_
